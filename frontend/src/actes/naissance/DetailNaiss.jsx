...
function DetailNaiss() {
  ...
  const generatePDF = () => {
    ...
    html2canvas(input, {
      ...
      pdf.save(`acte_naissance${acte.numero_acte}.pdf`);
    });
  };
    ...
    <div className="container mt-3">
      ...
      >
        ...
        <div className="d-flex justify-content-between align-items-center">
            <div>
                <h4 className="fw-bold mb-1">ACTE DE NAISSANCE </h4>
      ...
      <div className="mb-4 d-flex justify-content-between">
        <Link to="/dashboard?page=list_naiss" className="btn btn-secondary m-0">⬅ Retour</Link>
